...
import AtpList from '../common/list/AtpList';
import AtpButton from '../common/button/AtpButton';
import AtpPrice from '../../components/price/AtpPrice';
import AtpSelect from '../common/select/AtpSelect';
import AtpCarousel from '../common/carousel/AtpCarousel';
import AtpModal from '../common/modal/AtpModal';
      ...
      <div className="atp-article-desktop">
        <div className="atp-article-desktop__description">
          <div className="atp-article-desktop__description__text">
            ...
            <AtpText>
              {strings.SUPPLIER_COLOR} {article.supplierColor}
            </AtpText>
        ...
        <div className="atp-article-desktop__photos">
          {article.images.map((image, imageIndex) => (
            <img
              ...
              src={image.url}
              alt={image.title}
              className="atp-article-desktop__photos__photo"
              onClick={toggleModal}
            />
          ))}
        ...
        <div className="atp-article-desktop__actions">
          <div className="atp-article-desktop__actions__elements">
            ...
            />
            <AtpSelect
              selectValues={article.articleSize}
              name={'articleSize'}
              onSelect={onSelect}
            />
      ...
      <div className="atp-article-mobile">
        ...
        <div className="atp-article-mobile__description">
          ...
          <div className="atp-article-mobile__description__buttons">
            <AtpButton onClick={handleClick}>{strings.ADD_TO_BAG}</AtpButton>
            <AtpButton isSecondary>
              <HiOutlineHeart
                className="atp-article-mobile__description__buttons__icon-heart"
