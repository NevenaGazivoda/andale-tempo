...
export const AtpShoppingCart: FC = () => {
    const [cart, setCartItems] = useState(JSON.parse(localStorage.getItem("cart") || '[]') as CartItem[]);
        ...
        <div className='atp-page atp-shopping'>
            <div className='atp-shopping__cart'>
                ...
                <div className='atp-shopping__cart__total'>
                    ...
                    <b><AtpText>{strings.ORDER_TOTAL}</AtpText></b>
                    <b><AtpPrice price={calculateTotal(cart)}></AtpPrice></b>
                </div>
            </div>
